...
bool ros_gz_interfaces__msg__entity_wrench__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_gz_interfaces.msg._entity_wrench.EntityWrench", full_classname_dest, 49) == 0);
  }
  ros_gz_interfaces__msg__EntityWrench * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of EntityWrench */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_gz_interfaces.msg._entity_wrench");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EntityWrench");
