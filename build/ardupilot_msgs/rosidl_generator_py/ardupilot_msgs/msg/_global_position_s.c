...
bool ardupilot_msgs__msg__global_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ardupilot_msgs.msg._global_position.GlobalPosition", full_classname_dest, 50) == 0);
  }
  ardupilot_msgs__msg__GlobalPosition * ros_message = _ros_message;
  {  // header
  ...
  {  // type_mask
    ...
    assert(PyLong_Check(field));
    ros_message->type_mask = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // latitude
  ...
  {  // acceleration_or_force
    PyObject * field = PyObject_GetAttrString(_pymsg, "acceleration_or_force");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->acceleration_or_force)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of GlobalPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ardupilot_msgs.msg._global_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GlobalPosition");
  ...
  {  // acceleration_or_force
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->acceleration_or_force);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "acceleration_or_force", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
