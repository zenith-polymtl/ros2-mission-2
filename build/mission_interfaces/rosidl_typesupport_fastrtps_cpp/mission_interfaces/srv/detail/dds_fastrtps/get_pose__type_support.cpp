...
#include "mission_interfaces/srv/detail/get_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mission_interfaces::srv::GetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mission_interfaces::srv::GetPose_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mission_interfaces::srv::GetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mission_interfaces::srv::GetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mission_interfaces::srv::GetPose_Request *>(
    untyped_ros_message);
...
{
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mission_interfaces, srv, GetPose_Request)() {
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mission_interfaces
cdr_serialize(
  const mission_interfaces::srv::GetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mission_interfaces::srv::GetPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mission_interfaces::srv::GetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mission_interfaces::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mission_interfaces::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mission_interfaces, srv, GetPose_Response)() {
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
{
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mission_interfaces, srv, GetPose)() {
  return &mission_interfaces::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
